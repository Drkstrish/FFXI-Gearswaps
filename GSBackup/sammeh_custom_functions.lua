...
function disable_specialgear()
    ...
    if player.equipment.ring2 == 'Dim. Ring (Holla)' or player.equipment.ring2 == 'Warp Ring' or player.equipment.ring2 == 'Trizek Ring' or player.equipment.ring2 == 'Capacity Ring' or player.equipment.ring2 == "Vocation Ring" or player.equipment.ring1 == 'Facility Ring' then
        disable('ring2')
    else
        enable('ring2')
    end
...
sets.moving.THF = {feet="Jute Boots +1"}
...
sets.notmoving = {}
sets.notmoving.BLM = { name="Merlinic Crackows", augments={'INT+1','Phys. dmg. taken -4%','"Refresh"+1','Accuracy+8 Attack+8'}}
sets.notmoving.SCH = { name="Merlinic Crackows", augments={'INT+1','Phys. dmg. taken -4%','"Refresh"+1','Accuracy+8 Attack+8'}}
sets.notmoving.RNG = {legs={ name="Herculean Trousers", augments={'Rng.Acc.+23 Rng.Atk.+23','Enmity-1','AGI+7','Rng.Atk.+15'}}}
sets.notmoving.THF = {feet={ name="Herculean Boots", augments={'Accuracy+14 Attack+14','"Triple Atk."+4','VIT+6','Accuracy+5'}}}
sets.notmoving.BLU = {legs="Samnuha Tights"}
