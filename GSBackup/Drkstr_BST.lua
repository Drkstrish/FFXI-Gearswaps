-------------------------------------------------------------------------------------------------------------------
-- falk Last Revised: May 12th, 2016
-- me last revised? who knows
...
function init_gear_sets()
  ...
  Pet_MDT_AxeSub = "Arktoi"
	...
	Ready_Atk_Axe = 
  {name="Kumbhakarna", augments={'Pet: Accuracy+19 Pet: Rng. Acc.+19','Pet: Phys. dmg. taken -2%','Pet: TP Bonus+180'}}
  ...
  Ready_MAB_Axe = 
  {name="Nibiru Tabar", augments={'Pet: Attack+25','Pet: "Mag.Atk.Bns."+15','Pet: Enmity+7'}}
  ...
  sets.precast.JA['Bestial Loyalty'] = 
{
  ...
  {back="Artio's Mantle",feet="Ferine Ocreae +1"}
  
  sets.precast.SpurPetOnly = 
  set_combine(sets.precast.JA.Spur, {main="Skullrender"})
  
  sets.precast.SpurPetOnlyDW = 
  set_combine(sets.precast.JA.Spur, {main="Skullrender",sub="Skullrender"})
  ...
  sets.precast.JA.Reward = 
{
  ...
  sets.precast.JA.RewardPetOnly = set_combine(sets.precast.JA.Reward, {main=Reward_Axe,sub="Adapa Shield"})
  ...
  sets.midcast.Pet.WS = 
{
  ...
  set_combine(sets.midcast.Pet.WS, 
{
  head=Ready_MAB_head,
  neck="Adad Amulet",
  ear1="Sabong Earring",
  ...
  set_combine(sets.midcast.Pet.WS, 
{
  ...
  feet=Ready_MAcc_feet
    ...
    sets.midcast.Pet.ReadyDWNE = set_combine(sets.midcast.Pet.ReadyNE, {sub="Arktoi"}) -- +224 Acc
	
    sets.midcast.Pet.ReadyDWNE.MedAcc = set_combine(sets.midcast.Pet.ReadyNE.MedAcc, {sub="Arktoi"}) -- +239
	
    sets.midcast.Pet.ReadyDWNE.HighAcc = set_combine(sets.midcast.Pet.ReadyNE.HighAcc, {sub="Kerehcatl"}) -- +253
	
    sets.midcast.Pet.ReadyDWNE.MaxAcc = set_combine(sets.midcast.Pet.ReadyNE.MaxAcc, {sub="Kerehcatl"}) -- +290
