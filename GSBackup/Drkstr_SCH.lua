...
function init_gear_sets()
	...
	idle_ear1="Etiolation Earring"
	idle_ear2="Loquac. Earring"
	idle_body={ name="Amalric Doublet", augments={'MP+60','Mag. Acc.+15','"Mag.Atk.Bns."+15'}}
	idle_hands={ name="Amalric Gages", augments={'INT+10','Mag. Acc.+15','"Mag.Atk.Bns."+15'}}
	...
	FC_ranged=""
	FC_ammo="Elis Tome"
	FC_head={ name="Merlinic Hood", augments={'Mag. Acc.+17 "Mag.Atk.Bns."+17','"Fast Cast"+6','INT+6','Mag. Acc.+10','"Mag.Atk.Bns."+14'}} -- 14
	FC_neck="Orunmila's torque" --5
	FC_ear1="Etiolation Earring" --1
	FC_ear2="Loquac. Earring" --2
	FC_body="Shango Robe" --8
	FC_hands={ name="Amalric Gages", augments={'INT+10','Mag. Acc.+15','"Mag.Atk.Bns."+15'}}
	FC_ring1="Rahab Ring" --2
	FC_ring2="Lebeche Ring" --QM2
	FC_back="Perimede Cape" --QM4
	FC_waist="Channeler's Stone" --2
	FC_legs="Psycloth Lappas" --7
	FC_feet={ name="Merlinic Crackows", augments={'Mag. Acc.+24 "Mag.Atk.Bns."+24','Magic burst mdg.+7%','CHR+2','Mag. Acc.+6','"Mag.Atk.Bns."+14'}}
	...
	enh_ranged=""
	enh_ammo="Seraphic Ampulla"
	enh_head="Befouled Crown"
	enh_neck=FC_neck
	enh_ear1=FC_ear1
	enh_ear2=FC_ear2
	enh_body=idle_body
	enh_hands=idle_hands
	enh_ring1=FC_ring1
	enh_ring2=FC_ring2
	enh_back=FC_back
	enh_waist=FC_waist
	...
	cure_ear1="Etiolation Earring"
	cure_ear2="Mendicant's Earring"
	cure_body="Vanya Robe"
	cure_hands="Vanya Cuffs"
	cure_ring1="Rahab Ring"
	cure_ring2="Lebeche Ring"
	...
	ele_ear2="Hecate's Earring"
	ele_body={ name="Merlinic Jubbah", augments={'Mag. Acc.+24 "Mag.Atk.Bns."+24','Magic burst mdg.+10%','CHR+7'}}
	ele_hands={ name="Merlinic Dastanas", augments={'Mag. Acc.+21 "Mag.Atk.Bns."+21','INT+8','Mag. Acc.+3','"Mag.Atk.Bns."+15'}}
	ele_ring1="Shiva Ring"
	ele_ring2="Vertigo Ring"
	ele_back="Taranus's Cape"
	ele_waist="Refoccilation Stone"
	ele_legs={ name="Amalric Slops", augments={'MP+60','Mag. Acc.+15','"Mag.Atk.Bns."+15'}}
	ele_feet={ name="Merlinic Crackows", augments={'Mag. Acc.+24 "Mag.Atk.Bns."+24','Magic burst mdg.+7%','CHR+2','Mag. Acc.+6','"Mag.Atk.Bns."+14'}}
	
	ele_macc_ammo=ele_ammo
	ele_macc_head=ele_head
	ele_macc_neck=ele_neck
	ele_macc_ear1="Dignitary's Earring"
	ele_macc_ear2="Gwati Earring"
	ele_macc_body={ name="Amalric Doublet", augments={'MP+60','Mag. Acc.+15','"Mag.Atk.Bns."+15'}}
	ele_macc_hands={ name="Amalric Gages", augments={'INT+10','Mag. Acc.+15','"Mag.Atk.Bns."+15'}}
	ele_macc_ring1="Etana Ring"
	ele_macc_ring2="Resonance Ring"
	ele_macc_back=ele_back
	ele_macc_waist="Luminary Sash"
	ele_macc_legs={ name="Merlinic Shalwar", augments={'Mag. Acc.+24 "Mag.Atk.Bns."+24','"Occult Acumen"+9','CHR+5','"Mag.Atk.Bns."+13'}}
	ele_macc_feet={ name="Merlinic Crackows", augments={'Mag. Acc.+24 "Mag.Atk.Bns."+24','Magic burst mdg.+7%','CHR+2','Mag. Acc.+6','"Mag.Atk.Bns."+14'}}
	...
	ele_burst_ammo="Pemphredo Tathlum"
	ele_burst_head=ele_head -- 4
	ele_burst_neck="Mizu. Kubikazari" -- 10
	ele_burst_ear1="Dignitary Earring"
	ele_burst_ear2="Friomisi Earring"
	ele_burst_body={ name="Merlinic Jubbah", augments={'Mag. Acc.+24 "Mag.Atk.Bns."+24','Magic burst mdg.+10%','CHR+7'}} --10
	ele_burst_hands="Amalric Gages" -- 5
	ele_burst_ring1="Resonance Ring"
	ele_burst_ring2="Mujin Band"  -- 5 
	ele_burst_back="Bookworm's Cape" -- 5
	ele_burst_waist="Refoccilation Stone"
	ele_burst_legs={ name="Merlinic Shalwar", augments={'"Mag.Atk.Bns."+21','Magic burst mdg.+9%','INT+1','Mag. Acc.+13'}} -- 9
	ele_burst_feet={ name="Merlinic Crackows", augments={'Mag. Acc.+24 "Mag.Atk.Bns."+24','Magic burst mdg.+7%','CHR+2','Mag. Acc.+6','"Mag.Atk.Bns."+14'}} -- 7
	
	dark_ammo="Pemphredo Tathlum"
	dark_head=ele_head
	dark_neck="Sanctity Necklace"
	dark_ear1="Dignitary Earring"
	dark_ear2="Gwati Earring"
	dark_body="Shango Robe"
	dark_hands="Merlinic Dastanas"
	dark_ring1="Etana Ring"
	dark_ring2="Excelsis Ring"
	dark_back="Bookworm's Cape"
	dark_waist="Eschan Stone"
	dark_legs={ name="Merlinic Shalwar", augments={'"Mag.Atk.Bns."+21','Magic burst mdg.+9%','INT+1','Mag. Acc.+13'}}
	dark_feet={ name="Merlinic Crackows", augments={'Mag. Acc.+24 "Mag.Atk.Bns."+24','Magic burst mdg.+7%','CHR+2','Mag. Acc.+6','"Mag.Atk.Bns."+14'}}
	
	enf_main="Akademos"
	enf_sub="Niobid Strap"
	enf_ranged=""
	enf_ammo="Pemphredo Tathlum"
	enf_head="Chironic Hat"
	...
	enf_back="Bookworm's Cape"
	enf_waist="Luminary Sash"
	enf_legs="Chironic Hose"
	enf_feet="Chironic Slippers"
