...
+1",body="Pummeler's Lorica +1",back="Cichol's
Mantle"}
...
   
sets.precast.JA["Warrior's Charge"] = {legs="Agoge
Cuisses +1"}
...
       
head="Carmine Mask +1", body={ name="Odyss.
Chestplate", augments={'Mag. Acc.+21','"Fast Cast"+6',}},

        back=Ank_STP,
neck="Orunmila's Torque",

        hands={
name="Leyline Gloves", augments={'Accuracy+1','Mag.
Acc.+5','"Mag.Atk.Bns."+5','"Fast Cast"+1',}},
waist="Tempus Fugit",

        legs="Eschite Cuisses", feet={
name="Odyssean Greaves", augments={'Mag. Acc.+9','"Fast
Cast"+5','INT+6',}},
...
       
ear1="Etiolation Earring", ear2="Loquacious
Earring"}
...
       
legs="Eschite Cuisses", feet={ name="Odyssean
Greaves", augments={'Mag. Acc.+9','"Fast Cast"+5','INT+6',}},
...
    feet={
name="Amm Greaves", augments={'HP+50','VIT+10','Accuracy+15','Damage
taken-2%',}},
...
       
ring1="Defending Ring", ring2={ name="Dark Ring",
augments={'Phys. dmg. taken -5%','Magic dmg. taken -5%',}},
...
    body={
name="Valorous Mail",
augments={'Accuracy+23','"Dbl.Atk."+5','DEX+8','Attack+13',}},

    hands="Emicho
Gauntlets",

    legs={
name="Odyssean Cuisses", augments={'Accuracy+29','"Store
TP"+6','DEX+10','Attack+12',}},

    feet={
name="Valorous Greaves", augments={'Accuracy+20
Attack+20','"Store TP"+7','DEX+4','Accuracy+12',}},
...
    back={
name="Cichol's Mantle", augments={'STR+20','Accuracy+20
Attack+20','Accuracy+10','"Dbl.Atk."+10',}}
...
    body={
name="Valorous Mail", augments={'Accuracy+22','"Store
TP"+7','VIT+6','Attack+11',}},

    hands={
name="Emicho Gauntlets", augments={'HP+50','DEX+10','Accuracy+15',}},

    legs={
name="Odyssean Cuisses", augments={'Accuracy+16
Attack+16','"Store TP"+5','STR+10','Accuracy+8',}},

    feet={
name="Valorous Greaves",
augments={'Accuracy+20','"Dbl.Atk."+5','Attack+2',}},
...
augments={'Accuracy+29','"Dbl.Atk."+5',}},
...
        back={
name="Ankou's Mantle", augments={'STR+20','Accuracy+20
Attack+20','"Dbl.Atk."+10',}}, neck="Combatant's Torque",

       
hands="Emicho Gauntlets", waist="Kentarch Belt +1",

        legs="Carmine
Cuisses +1", feet={ name="Valorous Greaves",
augments={'Accuracy+20 Attack+20','"Store
TP"+7','DEX+4','Accuracy+12',}},
...
        back={
name="Cichol's Mantle", augments={'STR+20','Accuracy+20
Attack+20','STR+10','"Dbl.Atk."+10',}}, neck="Combatant's
Torque",
...
       
legs="Boii Cuisses +1", feet={ name="Valorous
Greaves", augments={'Accuracy+20 Attack+20','"Store
TP"+7','DEX+4','Accuracy+12',}},
...
    body={
name="Souveran Cuirass", augments={'HP+80','Enmity+7','Potency of
...
    legs={
name="Souveran Diechlings", augments={'HP+80','Enmity+7','Potency of
"Cure" effect received +10%',}},

    feet={
name="Souveran Schuhs", augments={'HP+80','Enmity+7','Potency of
"Cure" effect received +10%',}},
...
        back={
name="Cichol's Mantle", augments={'STR+20','Accuracy+20
Attack+20','Accuracy+10','"Dbl.Atk."+10',}}, neck="Fotia
Gorget",
...
       
legs="Argosy Breeches +1", feet="Argosy Sollerets
+1",
...
        head={
name="Odyssean Helm", augments={'Accuracy+21','Weapon skill damage
+5%','STR+9','Attack+14',}},

        body={ name="Valorous
Mail", augments={'Accuracy+28','Weapon skill damage +5%',}},

        hands={
name="Odyssean Gauntlets", augments={'Accuracy+29','Weapon skill
damage +5%','AGI+5','Attack+5',}},

        legs={
name="Valor. Hose", augments={'Accuracy+28','Weapon skill damage
+5%','STR+10','Attack+5',}},
...
        back={
name="Cichol's Mantle", augments={'STR+20','Accuracy+20
Attack+20','Weapon skill damage +10%',}}}

     

   
sets.precast.WS['Savage Blade'].Acc = {ammo="Seeth. Bomblet
+1",

        head={
name="Argosy Celata +1", augments={'STR+12','DEX+12','Attack+20',}},

        body={
name="Argosy Hauberk +1", augments={'STR+12','Attack+20','"Store
TP"+6',}},
...
    sets.MS_WS =
{ammo="Yetshila", feet="Boii Calligae +1"}
...
    if  Rag_weapons:contains(player.equipment.main)
then
...
-- eventArgs is the same one used in job_precast, in case
information needs to be persisted.

moonshade_WS = S{"Resolution",
"Torcleaver", "Savage Blade"}
...
        if world.time
>= (17*60) or world.time <= (7*60) then

           
equip({ear1="Lugra Earring +1",ear2="Lugra
Earring"})

        end

        if
moonshade_WS:contains(spell.english) and player.tp<2950 then  
...
        if
buffactive['Mighty Strikes'] then 

            if
sets.precast.WS[spell] then
...
                equipSet =
set_combine(equipSet,sets.MS_WS)
